...
const routes = [
  {
    path: "/",
    component: () => __vitePreload(() => import("./MainLayout.4553adac.js"), true ? ["assets/MainLayout.4553adac.js","assets/QBtn.f143e8e4.js","assets/render.cbcddda5.js"] : void 0),
    children: [{ path: "", component: () => __vitePreload(() => import("./IndexPage.d976e1d1.js"), true ? ["assets/IndexPage.d976e1d1.js","assets/render.cbcddda5.js"] : void 0) }]
  },
  {
    path: "/:catchAll(.*)*",
    component: () => __vitePreload(() => import("./ErrorNotFound.13b7f215.js"), true ? ["assets/ErrorNotFound.13b7f215.js","assets/QBtn.f143e8e4.js","assets/render.cbcddda5.js"] : void 0)
  }
];
...
createQuasarApp(createApp, quasarUserOptions).then((app2) => {
  return Promise.all([
    __vitePreload(() => import("./i18n.f33aa7eb.js"), true ? [] : void 0),
    __vitePreload(() => import("./axios.5feefae8.js"), true ? [] : void 0)
  ]).then((bootFiles) => {
    const boot2 = bootFiles.map((entry) => entry.default).filter((entry) => typeof entry === "function");
    start(app2, boot2);
  });
});
export { cleanEvt as A, withDirectives as B, provide as C, pageContainerKey as D, reactive as E, Fragment as F, isKeyCode as G, History as H, defineComponent as I, openBlock as J, createBlock as K, withCtx as L, createCommentVNode as M, createTextVNode as N, toDisplayString as O, Platform as P, resolveComponent as Q, createBaseVNode as R, createElementBlock as S, Text as T, renderList as U, mergeProps as V, Transition as W, markRaw as X, toRef as Y, _export_sfc as _, inject as a, onUnmounted as b, computed as c, createVNode as d, boot as e, isRuntimeSsrPreHydration as f, getCurrentInstance as g, h, isRef as i, onBeforeUnmount as j, noop$1 as k, listenOpts as l, layoutKey as m, nextTick as n, onMounted as o, client as p, getEventPath as q, ref as r, stopAndPrevent as s, leftClick as t, addEvt as u, preventDraggable as v, watch as w, prevent as x, stop as y, position as z };
